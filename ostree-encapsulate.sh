...
declare IMAGE=${IMAGE:="ghcr.io/frap129/trellis:testing"}
...
tar -x ${TAR_PATH} -C ${OSTREE_SYS_TREE}
...
declare OSTREE_SYS_PATH=$(ls -d ${OSTREE_SYS_ROOT}/ostree/deploy/${SYSTEM_BASE_NAME}/deploy/* | head -n 1)
...
ostree-ext-cli tar export --repo=${OSTREE_SYS_ROOT}/ostree/repo --format-version 1 0
